...
public class InsuranceTest {
   ...
   private static Object[][] testData1 = new Object[][] {
      ...
      // Decision Tables
      { "T8.1",                20,  Status.YES,    true,      2000},
      { "T8.2",                35,  Status.YES,    true,      300},
      { "T8.3",                50,  Status.YES,    true,      300},
      { "T8.4",                69,  Status.YES,    true,      0},
      { "T8.5",                20,  Status.YES,    false,      2000},
      { "T8.6",                40,  Status.YES,    false,      300},
      { "T8.7",                60,  Status.YES,    false,      500},
      { "T8.8",                105,  Status.YES,    false,      0},
   };
